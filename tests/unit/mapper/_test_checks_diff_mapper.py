...
def testMap_givenDiffDictFilename_shouldReturnDiffList():
    ...
    expected_checks_dict = {"diff": diff}
    expected_checks = map_checks(expected_checks_dict)
    assert expected_checks.diff == DiffList({"file1.md": DiffIndex("file1.md")})
...
def testMap_givenDiffDictFilenameSingleLine_shouldReturnDiffList():
    ...
    assert expected_checks.diff == DiffList(
        {"file1.md": DiffIndex("file1.md", additions={"line1": 1})}
    )
...
-line2
    ...
    assert expected_checks.diff == DiffList(
        {
            "file1.md": DiffIndex(
                "file1.md", additions={"line1": 2, "line2": 1}, deletions={"line3": 2, "line4": 1}
            ),
            "file2.md": DiffIndex("file2.md", additions={"line1": 1}, deletions={"line2": 1}),
        }
    )
